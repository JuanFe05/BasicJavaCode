package uninorte.Sesion6.Ejercicio1;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < arrayDatos.length; i++) {
            ...
            if (arrayDatos[i].solicitarPedido()) { System.err.println("ALERTA CÓDGO: " + arrayDatos[i].getCodigo()); }
            else { System.err.println("CÓDIGO: " + arrayDatos[i].getCodigo() + " NO NECESITA PEDIDO"); }
